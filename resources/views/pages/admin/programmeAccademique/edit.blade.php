...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <!-- Edit Programme Académique Start -->
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-7 col-xl-6">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <h3>Modifier un Programme Académique</h3>
                    </div>
                    ...
                    <form method="POST" action="{{ route('programme.update', $programme->id) }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="annee_accademique" id="annee_accademique"
                                   value="{{ old('annee_accademique', $programme->annee_accademique) }}" required
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="date_ouverture_inscription" id="date_ouverture_inscription"
                                   value="{{ old('date_ouverture_inscription', \Carbon\Carbon::parse($programme->date_ouverture_inscription)->format('Y-m-d')) }}"
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" name="date_fermeture_inscription" id="date_fermeture_inscription"
                                   value="{{ old('date_fermeture_inscription', \Carbon\Carbon::parse($programme->date_fermeture_inscription)->format('Y-m-d')) }}"
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="etat" id="etat" value="1"
                                {{ old('etat', $programme->etat) ? 'checked' : '' }}>
                            <label class="form-check-label" for="etat">Actif</label>
                        </div>

                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Mettre à jour le Programme</button>
                    </form>
